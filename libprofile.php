...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
 ...
 Suspension End Date:
     ...
     <strong><br><br>****If no date is picked the system will default to seven days****</strong>
<br><br>
        <?php
        if ($libsuspend=="1") {
            echo "Your Library has <strong>enable suspension</strong> until <strong>".$enddate."</strong><br>";
        } else {
            echo "Your Library has suspension disabled<br>";
        } ?>

      <br><br>
      <b>Items willing to loan in eForm</b><br><br>
        <table>
        <tr>
