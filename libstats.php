...
$enddate = date('Y-m-d H:i:s', strtotime(str_replace('-', '/', $enddated)));
 ...
 #Get total requests
$GETREQUESTCOUNTSQLL= "SELECT * FROM `$cdlcSTAT` WHERE `Requester LOC` LIKE '$loc'   and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00' ";
$retval = mysqli_query($db, $GETREQUESTCOUNTSQLL);
$row_cnt = mysqli_num_rows($retval);

 #Get total filled requests
$FINDFILL= "SELECT * FROM `$cdlcSTAT` WHERE `Requester LOC` LIKE '$loc'     and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'  and  Fill =1 ";
...
$FINDNOTFILL= "SELECT * FROM `$cdlcSTAT` WHERE `Requester LOC` LIKE '$loc'   and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'  and  Fill =0 ";
...
$FINDEXPIRE= "SELECT * FROM `$cdlcSTAT` WHERE `Requester LOC` LIKE '$loc'   and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'  and  Fill =4 ";
...
$FINDNOANSW= "SELECT * FROM `$cdlcSTAT` WHERE `Requester LOC` LIKE '$loc'   and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'  and  Fill =3 ";
...
$CANANSW= "SELECT * FROM `$cdlcSTAT` WHERE `Requester LOC` LIKE '$loc'    and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'  and  Fill =6 ";
...
$libnames= "SELECT Name FROM `$cdlcLIB` WHERE `LOC` LIKE '$loc'  ";
...
$libname =  $row["Name"];
   ...
   $destsystemq = mysqli_query($db, $destsystem);
    ...
    while ($row = mysqli_fetch_assoc($destsystemq)) {
        ...
        $destsystemcount=" SELECT `itype`  FROM `$cdlcSTAT` WHERE `Requester LOC` LIKE '$loc'   and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'  ";
...
if (strcmp($dessysvar,'CRB')==0){
   ...
   $dessysvartxt = "CDLC Group";
        ...
        $destitype=" SELECT distinct (`itype` )  FROM `$cdlcSTAT`  WHERE `Requester LOC` LIKE '$loc'    and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00' ";
        ...
        while ($row2 = mysqli_fetch_assoc($destitypeq)) {
            ...
            $destitemcount=" SELECT `fill`  FROM `$cdlcSTAT` WHERE `Itype`='$dessysitype' and `Requester LOC` LIKE '$loc'  and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'";
           ...
           $percent_friendly_typesys = number_format($percenttypesys_rows * 100, 2 ) . '%';
            ...
            $destitemcountfill=" SELECT `fill`  FROM `$cdlcSTAT` WHERE Fill='1' and `Itype`='$dessysitype' and `Requester LOC` LIKE '$loc'   and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'";
           ...
           $percent_friendly_1 = number_format($percent1_rows * 100, 2 ) . '%';
            ...
            $destitemcountunfill=" SELECT `fill`  FROM `$cdlcSTAT` WHERE Fill='0' and `Itype`='$dessysitype' and `Requester LOC` LIKE '$loc'   and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'";
           ...
           #Find what the expire rate is
            $destitemcountexfill=" SELECT `fill`  FROM `$cdlcSTAT` WHERE Fill='4' and `Itype`='$dessysitype' and `Requester LOC` LIKE '$loc'  and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'";
           ...
           #Find what the cancel rate is
            $destitemcountcanfill=" SELECT `fill`  FROM `$cdlcSTAT` WHERE Fill='6' and `Itype`='$dessysitype' and `Requester LOC` LIKE '$loc'  and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'";
           ...
           $percent_friendly_4 = number_format($percent4_rows * 100, 2 ) . '%';
            ...
            $destitemcountnoanswfill=" SELECT `fill`  FROM `$cdlcSTAT` WHERE Fill='3' and `Itype`='$dessysitype' and `Requester LOC` LIKE '$loc'  and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'";
