...
$FINDFILL= "SELECT * FROM `$cdlcSTAT` WHERE `Destination` LIKE '$loc'     and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'  and  Fill =1 ";
...
$FINDNOTFILL= "SELECT * FROM `$cdlcSTAT` WHERE `Destination` LIKE '$loc'   and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'  and  Fill =0 ";
...
$FINDEXPIRE= "SELECT * FROM `$cdlcSTAT` WHERE `Destination` LIKE '$loc'   and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'  and  Fill =4 ";
...
$FINDNOANSW= "SELECT * FROM `$cdlcSTAT` WHERE `Destination` LIKE '$loc'   and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'  and  Fill =3 ";
...
$CANANSW= "SELECT * FROM `$cdlcSTAT` WHERE `Destination` LIKE '$loc'    and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'  and  Fill =6 ";
...
$libname =  $row["Name"];
   ...
   $reqsystem=" SELECT distinct (`ReqSystem` )  FROM `$cdlcSTAT` WHERE `Destination` LIKE '$loc'   and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'  ";
   $reqsystemq = mysqli_query($db, $reqsystem);
    ...
    while ($row = mysqli_fetch_assoc($reqsystemq)) {
        ...
        $reqsystemcount=" SELECT `itype`  FROM `$cdlcSTAT` WHERE `Destination` LIKE '$loc'   and `ReqSystem`='$reqsysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'  ";
...
if (strcmp($reqsysvar,'CRB')==0){
   ...
   $reqsysvartxt = "CDLC Group";
        ...
        $reqtitype=" SELECT distinct (`itype` )  FROM `$cdlcSTAT`  WHERE `Destination` LIKE '$loc'    and `ReqSystem`='$reqsysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00' ";
        ...
        while ($row2 = mysqli_fetch_assoc($reqtitypeq)) {
            ...
            $reqitemcount=" SELECT `fill`  FROM `$cdlcSTAT` WHERE `Itype`='$reqsysitype' and `Destination` LIKE '$loc'  and `ReqSystem`='$reqsysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'";
           ...
           $percent_friendly_typesys = number_format($percenttypesys_rows * 100, 2 ) . '%';
            ...
            $reqtitemcountfill=" SELECT `fill`  FROM `$cdlcSTAT` WHERE Fill='1' and `Itype`='$reqsysitype' and `Destination` LIKE '$loc'   and `ReqSystem`='$reqsysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'";
           ...
           $percent_friendly_1 = number_format($percent1_rows * 100, 2 ) . '%';
            ...
            $reqitemcountunfill=" SELECT `fill`  FROM `$cdlcSTAT` WHERE Fill='0' and `Itype`='$reqsysitype' and `Destination` LIKE '$loc'   and `ReqSystem`='$reqsysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'";
           ...
           #Find what the expire rate is
            $reqitemcountexfill=" SELECT `fill`  FROM `$cdlcSTAT` WHERE Fill='4' and `Itype`='$reqsysitype' and `Destination` LIKE '$loc'  and `ReqSystem`='$reqsysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'";
           ...
           #Find what the cancel rate is
            $reqitemcountcanfill=" SELECT `fill`  FROM `$cdlcSTAT` WHERE Fill='6' and `Itype`='$reqsysitype' and `Destination` LIKE '$loc'  and `ReqSystem`='$reqsysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'";
           ...
           $percent_friendly_4 = number_format($percent4_rows * 100, 2 ) . '%';
            ...
            $reqitemcountnoanswfill=" SELECT `fill`  FROM `$cdlcSTAT` WHERE Fill='3' and `Itype`='$reqsysitype' and `Destination` LIKE '$loc'  and `ReqSystem`='$reqsysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 00:00:00'";
