...
$sqlselect="SELECT * FROM `$cdlcSTAT` WHERE `DueDate` = '".$fivedays."' and `receiveAccount` IS NOT NULL and `returnAccount` IS NULL AND `checkinAccount` IS NULL ORDER BY `index` ASC";
