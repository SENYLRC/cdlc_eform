...
while ($row = mysqli_fetch_assoc($retval)) {
    ...
    ###Get the Destination
    $GETLISTSQLDESTEMAIL="SELECT `ILL Email` FROM `$cdlcLIB` where loc LIKE '$destination'  limit 1";
...
<br>
This is an automated message from the eForm ILL System. Responses to this email will be sent back to staff at Southeastern NY Library Resources Council. If you would like to contact the other library in t
